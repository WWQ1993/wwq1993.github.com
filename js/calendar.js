 ...
 */
WWQ = {};
WWQ.calendar = function (leftImgUrl,rightImgUrl,callback) {
    ...
    function updateCalendar(year, month) { //更新日期主体
        ...
        if ($('.w_main').length < 1) {  //没有日历组件则新建
            $('head').append('<style>.w_main{width:100%;height:100%;position:relative}.w_main *{margin:0;padding:0}.w_main .chooser{width:100%;height:15%}.w_main .chooser div{display:inline-block}.w_main .chooser>div{width:50%;height:100%}.w_main .chooser>div .before,.w_main .chooser>div .after{width:30%;height:100%;vertical-align:middle;cursor:pointer}.w_main .chooser>div .before:hover,.w_main .chooser>div .after:hover{background-color:#4cccc4}.w_main .chooser>div .before:active,.w_main .chooser>div .after:active{cursor:inherit}.w_main .chooser>div .before{background:url("'+leftImgUrl+'") center no-repeat}.w_main .chooser>div .after{background:url("'+rightImgUrl+'") center no-repeat}.w_main .chooser .w_year,.w_main .chooser .w_month{width:40%;line-height:100%;text-align:center;vertical-align:middle;cursor:pointer}.w_main .chooser .w_year:active,.w_main .chooser .w_month:active{cursor:inherit}.w_main .weekNames{width:95%;line-height:2em;text-align:center;margin:auto;border-bottom:solid 1px #4cccc4}.w_main .weekNames .weekname{display:inline-block;width:14.25%;line-height:100%;color:#4cccc4}.w_main .w_days{width:95%;height:60%;margin:auto}.w_main .w_days .w_day{width:14.28%;height:17%;display:inline-block;text-align:center;vertical-align:middle;cursor:pointer}.w_main .w_days .not_day{width:14.28%;height:17%;display:inline-block}.w_main .w_days .w_day:hover{background-color:#4cccc4}.w_main .w_days .w_day:active{cursor:inherit}.w_main .w_days .w_day:before{content:" ";display:inline-block;vertical-align:middle;width:0;height:100%}.w_main .w_days .choose{background-color:#ffeb3b}.w_main .w_btns{width:65%;text-align:center;height:13%;float:right}.w_main .w_btns>a{display:inline-block;color:#4cccc4;text-decoration:none;width:33%;height:100%;vertical-align:middle}.w_main .w_btns>.w_btn0{color:#66cc91}.w_main .w_btns>a:before{content:" ";display:inline-block;vertical-align:middle;width:0;height:100%}.w_main .w_btns>a:hover{text-decoration:underline}.w_main .w_btns>a:active{cursor:inherit}.w_main .pop{display:none;background-color:white;box-sizing:border-box;width:20%;height:85%;border:solid 1px #dbdbdb;position:absolute;top:15%}.w_main .popYear{overflow-y:auto;left:15%}.w_main .popMonth{overflow-y:hidden;right:15%}.w_main .upArrow{display:none;position:absolute;top:12%;border-style:solid;border-width:6px;border-color:transparent transparent #dbdbdb transparent;height:0;width:0;font-size:0}.w_main .yearArrow{left:23%}.w_main .monthArrow{right:23%}.w_main .pop .item{width:100%;height:8.34%;box-sizing:border-box;border:solid 1px #dbdbdb;text-align:center;font-size:.7em;vertical-align:middle}.w_main .pop .item:before{content:" ";display:inline-block;vertical-align:middle;width:0;height:100%}.w_main .pop .item:hover{cursor:pointer;background:#e8e8e8}.w_main .pop .item.choose{background-color:#dbdbdb}</style>')
            $('.outer').append(strBefore + strMain + strAfter);
            component = {
                main: $('.w_main'),
                nowYear: $('.w_year', this.main),
                nowMonth: $('.w_month', this.main)
...
WWQ.calendar('./img/arrow_left.png','./img/arrow_right.png',function (ob) {
    console.log(ob);
});
